...
public class QuestionsError {
	 ...
	 */
	private List<QuestionError> questionsError;

	/**
	 * The default constructor.
	 */
	public QuestionsError() {
		questionsError = new ArrayList<QuestionError>();
	}
	 ...
	 *            : the new question
	 */
	public final void addQuestionError(final QuestionError value) {
		questionsError.add(value);
	}
	 ...
	 */
	public final List<QuestionError> getQuestionsError() {
	 ...
	 */
	@XmlElement
	public final void setQuestionsError(final List<QuestionError> value) {
